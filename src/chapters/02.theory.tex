...
Github is a collaboration platform for software development using Git~\cite{wiki:git}. Kdyby is hosted and developed here, such as many other Composer packages.
