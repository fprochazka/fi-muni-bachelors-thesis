...
\thesissetup{%
    ...
    keywords      = {Kdyby, package, Packagist, Composer, Nette Framework, Doctrine ORM, ORM, Symfony Framework, integration, refactoring, clean code, coding style, coding standard, PHP},
    TeXkeywords   = {Kdyby, package, Packagist, Composer, Nette Framework, Doctrine ORM, ORM, Symfony Framework, integration, refactoring, clean code, coding style, coding standard, PHP},
}
\thesislong{abstract}{%
    The primary goal of this thesis is to provide up-to-date versions of Kdyby packages that are compatible with current versions of libraries they integrate into Nette. A significant portion of that is creating more maintainable and coherent code resulting in easier releasing of new package versions.

    A detailed roadmap was compiled that will be the basis of future architectural changes in Kdyby packages.

    A custom Kdyby Coding Standard was created. Versions of almost all of the more successful Kdyby packages were released that support current Nette, Doctrine, and Symfony. Moreover the code of most Kdyby packages is now checked with a static analysis tool and adheres to the strict coding standard.
}
\thesislong{thanks}{%
