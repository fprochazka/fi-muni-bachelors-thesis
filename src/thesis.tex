...
\thesislong{abstract}{%
    ...
    A custom Kdyby Coding Standard was created. Versions of almost all of the more successful Kdyby packages were released that support current Nette, Doctrine, and Symfony. And the code of most Kdyby packages is now checked with a static analysis tool and adheres to the strict coding standard.
}
\thesislong{thanks}{%
