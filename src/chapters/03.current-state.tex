...
\fnurl{Wkhtmltopdf}{https://wkhtmltopdf.org/} is, among others, a PDF generator. It has CLI interface that accepts an HTML file, set of options and generates a PDF. \gls{kWkhtmltopdf} is a \gls{oo} abstraction of the CLI for \gls{nette}. It contains a lot of custom solutions for the subproblems that are not easy to maintain. There are also several new versions of the tool.
