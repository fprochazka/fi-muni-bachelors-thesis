...
The new Kdyby Coding Standard is be based on Consistence Coding Standard~\cite{consistence:coding-standard} with \fnurl{slevomat/coding-standard}{https://github.com/slevomat/coding-standard} rules.
